...
class TestToInt:
    """Test the _to_int helper used in repositories."""

    def test_valid_int(self):
        from backend.infrastructure.repositories.trips import _to_int
        assert _to_int(5) == 5
...
class TestToFloat:
    """Test the _to_float helper used in repositories."""

    def test_valid_float(self):
        from backend.infrastructure.repositories.fuel import _to_float
